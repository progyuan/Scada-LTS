...
public class PointValueAdnnotationDaoTest extends TestDAO{
	...
	public void test() {
		...
		// read
		  ...
		  PointValueAdnnotation pointValueAdnnotationNewLongText = pointValuesAdnnotationsDAO.findByPointValueId(1).get(0);		  
		  boolean test1 = pointValueAdnnotationNewLongText.equals(pointValueAdnnotationAlphanumericLongText);
		  assertTrue(test1);
		  
		  PointValueAdnnotation pointValueAdnnotationNewShortText = pointValuesAdnnotationsDAO.findByPointValueId(2).get(0);		  
		  boolean test2 = pointValueAdnnotationNewShortText.equals(pointValueAdnnotationAlphanumericShortText);
		  assertTrue(test2);
		  
		  PointValueAdnnotation pointValueAdnnotationNewImage1 = pointValuesAdnnotationsDAO.findByPointValueId(3).get(0);		  
		  boolean test3 = pointValueAdnnotationNewImage1.equals(pointValueAdnnotationImage1);
		  assertTrue(test3);
		  
		  PointValueAdnnotation pointValueAdnnotationNewImage2 = pointValuesAdnnotationsDAO.findByPointValueId(4).get(0);		  
